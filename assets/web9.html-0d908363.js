import{_ as e,o as t,c as s,e as i}from"./app-81cf5d26.js";const n={},l=i(`<p>#SQL注入</p><p>存在 robots.txt 文件</p><blockquote><p>robots.txt是一个文本文件,同时也是一个协议,规定了爬虫访问的规则( 哪些文件可以爬取,哪些文件不可以爬取)</p></blockquote><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>User-agent: *
Disallow: /index.phps
